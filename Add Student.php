<?php
    ...
    /*User Checking*/
    $select="SELECT username FROM student_login_details WHERE username=?" ;
    ...
    {
        $insert=mysqli_query($conn,"INSERT INTO student_login_details (username,pass) VALUES ('$username','$password')");
        if(!$insert)
        {
