...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2024 at 06:14 PM
...
--
-- Database: `marks_databases`
--
CREATE DATABASE IF NOT EXISTS `marks_databases` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `marks_databases`;
...
(6, '22352-CM-019', 'CME', '1', 1, 2024, 'Present', 0, 20, 20, 40, '', '2024-10-04 15:26:19');
...
DROP TABLE IF EXISTS `external1_marks`;
...
--
-- RELATIONSHIPS FOR TABLE `external1_marks`:
--
...
DROP TABLE IF EXISTS `external2_marks`;
...
--
-- RELATIONSHIPS FOR TABLE `external2_marks`:
--
...
DROP TABLE IF EXISTS `external3_marks`;
...
--
-- RELATIONSHIPS FOR TABLE `external3_marks`:
--
...
--
-- RELATIONSHIPS FOR TABLE `external_marks`:
--
...
DROP TABLE IF EXISTS `internal1_marks`;
...
--
-- RELATIONSHIPS FOR TABLE `internal1_marks`:
--
...
DROP TABLE IF EXISTS `internal2_marks`;
...
--
-- RELATIONSHIPS FOR TABLE `internal2_marks`:
--
...
DROP TABLE IF EXISTS `internal3_marks`;
...
--
-- RELATIONSHIPS FOR TABLE `internal3_marks`:
--
...
--
-- RELATIONSHIPS FOR TABLE `internal_marks`:
--
