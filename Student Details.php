...
if ($result->num_rows > 0) 
{
  echo '<script>
                ...
                window.location.href = "Student Details Form.php?name=" + encodeURIComponent(name); // Use encodeURIComponent
              </script>';
}
else
{
    $insert=mysqli_query($conn,"INSERT INTO Student_Details (pinno,studentname,branch,course,DOB,Admission_No,Admission_Type,Gender,Caste,Sub_Caste,Religion,Student_Aadhar,Ration_Card,EMail,Phone,Blood_Group,Mole1,Mole2,Permanent_Address,Present_Address,Year10,Hall_Ticket10,Institution10,Board10,Medium10,Total_Marks10,Obtained_Marks10,Percentage_of_Marks10,Marks_Certificate_No10,TC_No10,InYear,InHall_Ticket,InInstitution,InBoard,InMedium,InTotal_Marks,InObtained_Marks,In_Percentage_of_Marks,InMarks_Certificate_No,InTC_No,polyHall_Ticket,PolyMarks,PolyRank,Father_Name,Fage,FQualification,Foccupation,Faadhar,Fphone,Mother_Name,Mage,MQualification,Moccupation,Maadhar,Mphone) VALUES ( '$pinno','$studentname','$branch','$course','$Date_of_Birth','$Admission_No','$Admission_Type','$Gender','$Caste','$Sub_Caste','$Religion','$Aadhar_No','$Ration_Card_No','$E_Mail','$Phone','$Blood_Group','$Mole1','$Mole2','$Permanent_Address','$Present_Address','$Year10','$Hall_Ticket10','$Institution10','$Board10','$Medium10','$Total_Marks10','$Obtained_Marks10','$of_Marks10','$Marks_Certificate_No10','$TC_No10','$InYear','$InHall_Ticket','$InInstitution','$InBoard','$InMedium','$InTotal_Marks','$InObtained_Marks','$Inof_Marks','$InMarks_Certificate_No','$InTC_No','$polyHall_Ticket_No','$PolyMarks','$PolyRank','$Father_Name','$Fage','$Fqualification','$Foccupation','$Faadhar','$Fphone','$Mother_Name','$Mage','$Mqualification','$Moccupation','$Maadhar','$Mphone');");
    if (!$insert) {
        echo '<script>
